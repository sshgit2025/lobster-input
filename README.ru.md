...
Примерно **99,9%** проекта разработано с помощью **Claude 4.6** и **GPT-5.5**. На Claude пришлось около **95%** работы по разработке, а GPT-5.5 в основном использовался для написания промптов для больших языковых моделей. **Доля ручных корректировок составила менее 0,1%.**
