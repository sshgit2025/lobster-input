; *** Inno Setup version 6.5.0+ Cantonese messages ***
;
...
AboutSetupNote=
TranslatorNote=简体中文翻译由 Kira（developer@example.com）维护。项目地址：https://github.com/kira-96/Inno-Setup-Chinese-Simplified-Translation
